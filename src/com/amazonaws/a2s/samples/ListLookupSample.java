...
public class ListLookupSample {
    ...
    public static void main(String... args) {
         ...
         * sample for List Lookup Request
         ***********************************************************************/
         ...
         // invokeListLookup(service, request);
     ...
     * @param request  ListLookup request
     */
    public static void invokeListLookup(AmazonA2S service, ListLookupRequest... request) {
        try {

            ListLookupResponse response = service.listLookup(request);

            
            System.out.println ("ListLookup Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.print("    ListLookupResponse");
            System.out.println();
            ...
            java.util.List<Lists> listssList = response.getLists();
            for (Lists lists : listssList) {
                System.out.print("        Lists");
                System.out.println();
                if (lists.isSetTotalResults()) {
                    System.out.print("            TotalResults");
                    System.out.println();
                    System.out.print("                " + lists.getTotalResults());
                    System.out.println();
                }
                if (lists.isSetTotalPages()) {
                    System.out.print("            TotalPages");
                    System.out.println();
                    System.out.print("                " + lists.getTotalPages());
                    System.out.println();
                }
                java.util.List<List> listsList = lists.getList();
                for (List list : listsList) {
                    ...
                    if (list.isSetListURL()) {
                        System.out.print("                ListURL");
                        System.out.println();
                        System.out.print("                    " + list.getListURL());
                        System.out.println();
                    }
                    if (list.isSetRegistryNumber()) {
                        System.out.print("                RegistryNumber");
                        System.out.println();
                        System.out.print("                    " + list.getRegistryNumber());
                        System.out.println();
                    }
                    if (list.isSetListName()) {
                        System.out.print("                ListName");
                        System.out.println();
                        System.out.print("                    " + list.getListName());
                        System.out.println();
                    }
                    if (list.isSetListType()) {
                        System.out.print("                ListType");
                        System.out.println();
                        System.out.print("                    " + list.getListType());
                        System.out.println();
                    }
                    if (list.isSetTotalItems()) {
                        System.out.print("                TotalItems");
                        System.out.println();
                        System.out.print("                    " + list.getTotalItems());
                        System.out.println();
                    }
                    if (list.isSetTotalPages()) {
                        System.out.print("                TotalPages");
                        System.out.println();
                        System.out.print("                    " + list.getTotalPages());
                        System.out.println();
                    }
                    if (list.isSetDateCreated()) {
                        System.out.print("                DateCreated");
                        System.out.println();
                        System.out.print("                    " + list.getDateCreated());
                        System.out.println();
                    }
                    if (list.isSetOccasionDate()) {
                        System.out.print("                OccasionDate");
                        System.out.println();
                        System.out.print("                    " + list.getOccasionDate());
                        System.out.println();
                    }
                    if (list.isSetCustomerName()) {
                        System.out.print("                CustomerName");
                        System.out.println();
                        System.out.print("                    " + list.getCustomerName());
                        System.out.println();
                    }
                    if (list.isSetPartnerName()) {
                        System.out.print("                PartnerName");
                        System.out.println();
                        System.out.print("                    " + list.getPartnerName());
                        System.out.println();
                    }
                    if (list.isSetAdditionalName()) {
                        System.out.print("                AdditionalName");
                        System.out.println();
                        System.out.print("                    " + list.getAdditionalName());
                        System.out.println();
                    }
                    if (list.isSetComment()) {
                        System.out.print("                Comment");
                        System.out.println();
                        System.out.print("                    " + list.getComment());
                        System.out.println();
                    }
                    if (list.isSetImage()) {
                        System.out.print("                Image");
                        System.out.println();
                        Image  image = list.getImage();
                        if (image.isSetURL()) {
                        ...
                        if (image.isSetHeight()) {
                            ...
                            System.out.println();
                            DecimalWithUnits  height = image.getHeight();
                        } 
                        if (image.isSetWidth()) {
                            System.out.print("                    Width");
                            System.out.println();
                            DecimalWithUnits  width = image.getWidth();
                        } 
                        if (image.isSetIsVerified()) {
                            System.out.print("                    IsVerified");
                            System.out.println();
                            System.out.print("                        " + image.getIsVerified());
                            System.out.println();
                        }
                    } 
                    if (list.isSetAverageRating()) {
                        ...
                        System.out.println();
                        System.out.print("                    " + list.getAverageRating());
                        System.out.println();
                    }
                    if (list.isSetTotalVotes()) {
                        System.out.print("                TotalVotes");
                        System.out.println();
                        System.out.print("                    " + list.getTotalVotes());
                        System.out.println();
                    }
                    if (list.isSetTotalTimesRead()) {
                        System.out.print("                TotalTimesRead");
                        System.out.println();
                        System.out.print("                    " + list.getTotalTimesRead());
                        System.out.println();
                    }
                    java.util.List<ListItem> listItemsList = list.getListItem();
                    for (ListItem listItem : listItemsList) {
                        System.out.print("                ListItem");
                        System.out.println();
                        if (listItem.isSetListItemId()) {
                            System.out.print("                    ListItemId");
                            System.out.println();
                            System.out.print("                        " + listItem.getListItemId());
                            System.out.println();
                        }
                        if (listItem.isSetDateAdded()) {
                            System.out.print("                    DateAdded");
                            System.out.println();
                            System.out.print("                        " + listItem.getDateAdded());
                            System.out.println();
                        }
                        if (listItem.isSetComment()) {
                            System.out.print("                    Comment");
                            System.out.println();
                            System.out.print("                        " + listItem.getComment());
                            System.out.println();
                        }
                        if (listItem.isSetQuantityDesired()) {
                            System.out.print("                    QuantityDesired");
                            System.out.println();
                            System.out.print("                        " + listItem.getQuantityDesired());
                            System.out.println();
                        }
                        if (listItem.isSetQuantityReceived()) {
                            System.out.print("                    QuantityReceived");
                            System.out.println();
                            System.out.print("                        " + listItem.getQuantityReceived());
                            System.out.println();
                        }
                        if (listItem.isSetItem()) {
