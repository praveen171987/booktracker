...
public class CartGetSample {
     ...
     * @param request  CartGet request
     */
    public static void invokeCartGet(AmazonA2S service, CartGetRequest... request) {
        try {

            CartGetResponse response = service.cartGet(request);

            
            System.out.println ("CartGet Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.print("    CartGetResponse");
            System.out.println();
