...
public class TagLookupSample {
    ...
    public static void main(String... args) {
         ...
         ***********************************************************************/
         ...
         // invokeTagLookup(service, request);
     ...
     * @param request  TagLookup request
     */
    public static void invokeTagLookup(AmazonA2S service, TagLookupRequest... request) {
        try {

            TagLookupResponse response = service.tagLookup(request);

            
            System.out.println ("TagLookup Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.print("    TagLookupResponse");
            System.out.println();
            ...
            java.util.List<Tags> tagssList = response.getTags();
            for (Tags tags : tagssList) {
