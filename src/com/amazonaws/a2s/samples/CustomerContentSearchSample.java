...
public class CustomerContentSearchSample {
     ...
     * Customer Content Search functionality
     *
     * @param args unused
     */
    public static void main(String... args) {
         ...
         * sample for Customer Content Search Request
         ***********************************************************************/
         ...
         // invokeCustomerContentSearch(service, request);
    ...
    /**
     * Customer Content Search Action Sample
     * 
     * <br><br>
     ...
     * @param request  CustomerContentSearch request
     */
    public static void invokeCustomerContentSearch(AmazonA2S service, CustomerContentSearchRequest... request) {
        try {

            CustomerContentSearchResponse response = service.customerContentSearch(request);

            
            System.out.println ("CustomerContentSearch Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.print("    CustomerContentSearchResponse");
            System.out.println();
            ...
            java.util.List<Customers> customerssList = response.getCustomers();
            for (Customers customers : customerssList) {
                System.out.print("        Customers");
                System.out.println();
                if (customers.isSetTotalResults()) {
                    System.out.print("            TotalResults");
                    System.out.println();
                    System.out.print("                " + customers.getTotalResults());
                    System.out.println();
                }
                if (customers.isSetTotalPages()) {
                    System.out.print("            TotalPages");
                    System.out.println();
                    System.out.print("                " + customers.getTotalPages());
                    System.out.println();
                }
                java.util.List<Customer> customersList = customers.getCustomer();
                for (Customer customer : customersList) {
                    ...
                    if (customer.isSetNickname()) {
                        ...
                        System.out.println();
                        System.out.print("                    " + customer.getNickname());
                        System.out.println();
                    }
                    ...
                    if (customer.isSetWishListId()) {
                        System.out.print("                WishListId");
                        System.out.println();
                        System.out.print("                    " + customer.getWishListId());
                        System.out.println();
                    }
                    if (customer.isSetLocation()) {
                        System.out.print("                Location");
                        System.out.println();
                        CustomerLocation  location = customer.getLocation();
                    ...
                    java.util.List<CustomerReviews> customerReviewssList = customer.getCustomerReviews();
                    for (CustomerReviews customerReviews : customerReviewssList) {
