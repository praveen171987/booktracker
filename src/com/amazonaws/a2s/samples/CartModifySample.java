...
public class CartModifySample {
    ...
    public static void main(String... args) {
         ...
         * sample for Cart Modify Request
         ***********************************************************************/
         ...
         // invokeCartModify(service, request);
     ...
     * @param request  CartModify request
     */
    public static void invokeCartModify(AmazonA2S service, CartModifyRequest... request) {
        try {
