...
public class CartCreateSample {
    ...
    public static void main(String... args) {
         ...
         * sample for Cart Create Request
         ***********************************************************************/
         ...
         // invokeCartCreate(service, request);
     ...
     * @param request  CartCreate request
     */
    public static void invokeCartCreate(AmazonA2S service, CartCreateRequest... request) {
        try {

            CartCreateResponse response = service.cartCreate(request);

            
            System.out.println ("CartCreate Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.print("    CartCreateResponse");
            System.out.println();
