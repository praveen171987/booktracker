...
public class CartAddSample {
     ...
     * @param request  CartAdd request
     */
    public static void invokeCartAdd(AmazonA2S service, CartAddRequest... request) {
        try {

            CartAddResponse response = service.cartAdd(request);

            
            System.out.println ("CartAdd Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.print("    CartAddResponse");
            System.out.println();
