...
public class CustomerContentLookupSample {
     ...
     * Customer Content Lookup functionality
     *
     * @param args unused
     */
    public static void main(String... args) {
         ...
         * sample for Customer Content Lookup Request
         ***********************************************************************/
         ...
         // invokeCustomerContentLookup(service, request);
    ...
    /**
     * Customer Content Lookup Action Sample
     * 
     * <br><br>
     ...
     * @param request  CustomerContentLookup request
     */
    public static void invokeCustomerContentLookup(AmazonA2S service, CustomerContentLookupRequest... request) {
        try {

            CustomerContentLookupResponse response = service.customerContentLookup(request);

            
            System.out.println ("CustomerContentLookup Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.print("    CustomerContentLookupResponse");
            System.out.println();
