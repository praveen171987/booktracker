...
public class ListSearchSample {
    ...
    public static void main(String... args) {
         ...
         * sample for List Search Request
         ***********************************************************************/
         ...
         // invokeListSearch(service, request);
     ...
     * @param request  ListSearch request
     */
    public static void invokeListSearch(AmazonA2S service, ListSearchRequest... request) {
        try {

            ListSearchResponse response = service.listSearch(request);

            
            System.out.println ("ListSearch Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.print("    ListSearchResponse");
            System.out.println();
